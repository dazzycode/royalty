...
const blogPosts = [
  {
    id: 1,
    title: "Royalty Recycling Hub Launches New Plastic Upcycling Initiative",
    image: "/explore1.png",
    date: "Nov 10, 2024",
  },
  {
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 lg:grid-cols-3 gap-12 font-sans text-gray-800">
      ...
      <div className="lg:col-span-2">
        ...
        <p className="text-sm text-gray-500 mb-6">Nov 10, 2024</p>
...
<div className="space-y-6">
  {blogPosts.map((post) => (
    <Link to={`/blog/${post.id}`} key={post.id} className="block hover:opacity-80 transition">
